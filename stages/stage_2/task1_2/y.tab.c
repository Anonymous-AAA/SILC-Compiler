...
{
       0,    25,    25,    29,    31,    32,    34,    35,    36,    38,
      40,    42,    45,    46,    47,    48,    49,    50,    51
};
#endif
...
static const char *const yytname[] =
{
  ...
  "MUL", "DIV", "END", "BEG", "READ", "WRITE", "ID", "EQUAL", "'('", "')'",
...
{
      23,    -7,     2,   -16,    20,    24,    26,    17,   -16,   -16,
     -16,   -16,   -16,    18,    21,    21,   -16,   -16,    25,   -16,
     -16,    21,    11,     3,    27,    16,    21,    21,    21,    21,
      28,   -16,   -16,   -16,    30,    30,   -16,   -16,   -16
};
...
{
      23,     3,    12,     4,     5,     6,    25,    26,    27,    28,
      29,    34,    35,    36,    37,    26,    27,    28,    29,    31,
      26,    27,    28,    29,    19,    16,    30,     4,     5,     6,
      18,    33,     1,    20,    13,    21,    28,    29,    14,    15,
      24,    17,     0,    32,    38
};

static const yytype_int8 yycheck[] =
{
      15,     8,     0,    10,    11,    12,    21,     4,     5,     6,
       7,    26,    27,    28,    29,     4,     5,     6,     7,    16,
       4,     5,     6,     7,     3,     8,    15,    10,    11,    12,
      12,    15,     9,    12,    14,    14,     6,     7,    14,    13,
      15,     7,    -1,    16,    16
};
...
static const yytype_int8 yystos[] =
{
      ...
      22,    23,     0,    14,    14,    13,     8,    20,    12,     3,
      12,    14,    24,    24,    15,    24,     4,     5,     6,     7,
      15,    16,    16,    15,    24,    24,    24,    24,    16
};
...
#line 38 "exprtree.y"
                                {(yyval.no) = makeSingleNode('r',(yyvsp[-2].no));}
#line 1217 "y.tab.c"
    break;

  case 10: /* OutputStmt: WRITE '(' expr ')' ';'  */
#line 40 "exprtree.y"
                                    {(yyval.no) = makeSingleNode('w',(yyvsp[-2].no));}
#line 1223 "y.tab.c"
    break;

  case 11: /* AsgStmt: ID EQUAL expr ';'  */
#line 42 "exprtree.y"
